...
from data.schemes_database import get_scheme_by_id, get_all_schemes, is_scheme_verified
...
class EligibilityMatcherAgent:
    ...
    def _rule_based_pre_filter(self, profile: dict, scheme: dict) -> tuple:
        ...
        if not is_scheme_verified(scheme):
            return False, "Scheme is not currently verified for recommendation"
